...
},{"./GoodGuy":1,"jquery":4,"moment":5,"underscore":6}],3:[function(require,module,exports){
'use strict';
...
(function () {
  ...
  describe('Guys', function () {
    describe('creating badGuys', function () {
      beforeEach(function () {
        window.dude = new _GoodGuy2['default']();
      });
      it('should be an instance of Guy', function () {
        expect(dude instanceof _GoodGuy2['default']).to.equal(true);
      });
...
},{"./GoodGuy":1,"./main":2,"underscore":6}],4:[function(require,module,exports){
/*!
